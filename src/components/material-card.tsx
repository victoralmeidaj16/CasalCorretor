  ...
  return (
    <div className="bg-secondary border border-accent/20 rounded-xl overflow-hidden card-gold-hover flex flex-col">
      ...
      <div className={`relative bg-gradient-to-br ${material.gradient} h-36 flex items-center justify-center`}>
        ...
        {material.type === "video" && (
          <div className="relative z-10 w-12 h-12 rounded-full border border-accent/40 bg-primary/60 backdrop-blur-sm flex items-center justify-center hover:bg-accent/20 transition-colors cursor-pointer">
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="mt-auto pt-3">
          {material.type !== "video" ? (
            <button className="w-full flex items-center justify-center gap-2 text-[10px] font-semibold tracking-[0.15em] uppercase border border-accent/30 text-accent hover:bg-accent hover:text-primary py-2 rounded-lg transition-all duration-200 hover:shadow-[0_0_12px_rgba(201,151,77,0.2)]">
              <Download size={12} strokeWidth={2} />
              Download
            </button>
          ) : (
            <button className="w-full flex items-center justify-center gap-2 text-[10px] font-semibold tracking-[0.15em] uppercase border border-accent/30 text-accent hover:bg-accent hover:text-primary py-2 rounded-lg transition-all duration-200">
